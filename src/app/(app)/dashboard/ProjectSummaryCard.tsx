    ...
    <div className="rounded-2xl border border-border bg-background p-5 print:rounded-xl print:p-2.5">
      ...
      */}
      ...
      {/*
        ...
        겹치는 것보다 훨씬 안전하다. 첫 열(유입경로)은 1.36fr, 방문 두 칸과
        주간 사전등록은 0.75fr, 누적 사전등록은 0.92fr — 도넛+범례를
        ...
        나뉘게 한다.
      */}
      <div className="mt-4 flex min-w-0 flex-nowrap items-stretch gap-3 overflow-x-auto pb-1 print:mt-1.5 print:grid print:grid-cols-[minmax(0,1.36fr)_minmax(0,0.75fr)_minmax(0,0.75fr)_minmax(0,0.75fr)_minmax(0,0.92fr)] print:gap-1 print:overflow-visible print:pb-0">
