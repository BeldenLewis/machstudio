    ...
    <div className="rounded-2xl border border-border bg-background p-5 print:rounded-xl print:p-2.5">
      ...
      */}
      ...
      {/*
        ...
        겹치는 것보다 훨씬 안전하다. 첫 열(유입경로)만 1.3fr, 나머지 0.875fr — 도넛+범례를
        ...
        핵심이다 — 그냥 "1.3fr 0.875fr ..." 만 쓰면 내용이 많은 칸(예: 누적 사전등록자의
        ...
        나뉘게 한다.
      */}
      <div className="mt-4 flex min-w-0 flex-nowrap items-stretch gap-3 overflow-x-auto pb-1 print:mt-1.5 print:grid print:grid-cols-[minmax(0,1.3fr)_minmax(0,0.875fr)_minmax(0,0.875fr)_minmax(0,0.875fr)_minmax(0,0.875fr)] print:gap-1 print:overflow-visible print:pb-0">
