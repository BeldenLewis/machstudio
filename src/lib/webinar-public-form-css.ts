...
.mw-submit { display:inline-flex; width:100%; min-height:46px; align-items:center; justify-content:center; margin-top:8px; padding:12px 18px; border:0; border-radius:9px; background:var(--mw-accent); color:#fff; font:inherit; font-size:14px; font-weight:700; cursor:pointer; box-shadow:0 4px 16px color-mix(in srgb,var(--mw-accent) 28%,transparent); transition:transform .18s ease,opacity .18s ease,box-shadow .18s ease; }
...
.mw-msg-error { display:block; background:color-mix(in srgb,#dc2626 8%,var(--mw-surface)); color:color-mix(in srgb,#dc2626 76%,var(--mw-text)); box-shadow:inset 0 0 0 1px color-mix(in srgb,#dc2626 24%,transparent); }
.mw-msg-success { display:block; background:color-mix(in srgb,#16a34a 8%,var(--mw-surface)); color:color-mix(in srgb,#16a34a 76%,var(--mw-text)); box-shadow:inset 0 0 0 1px color-mix(in srgb,#16a34a 24%,transparent); }
